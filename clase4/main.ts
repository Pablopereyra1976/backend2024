...
interface producto {  /*{nombre: string, precio: number, id: number, categoria: string, stock: number} reemplaza al tipoda en el objeto*/
    nombre: string,
    precio: number,
    id: number,
    categoria: string,
...
const manejador_usuario : ManejadorUsuarios = new ManejadorUsuarios()
